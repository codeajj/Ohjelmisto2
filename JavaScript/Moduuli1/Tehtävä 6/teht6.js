...
if (answer === true) {
    ...
    document.querySelector('#target').innerHTML = ("Square root of " + numberINT + " is " + square);
}
...
if (numberINT <= 0) {
    document.querySelector('#target').innerHTML = ("Cannot calculate a negative number or zero");
}